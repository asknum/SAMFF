...
def parse(args):
    ...
    import re
    # Remove inline comments but be careful not to remove // inside strings
    lines = content.splitlines()
    cleaned_lines = []
    for line in lines:
        # Simple approach: only remove comments that are clearly outside strings
        ...
        if '//' in line:
            ...
            if quotes_before % 2 == 0:  # Even number of quotes means we're outside a string
